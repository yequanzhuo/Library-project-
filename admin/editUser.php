...
$id=$_REQUEST['id'];
$sql="select id,username,name,pass,phone,academy,education,email from users where id='{$id}'";
$row=fetchOne($sql);
?>
<html>
<head>
...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
  ...
  <tr>
    ...
    <form method="post" action="doAdminAction.php?act=editUser&id=<?php echo $id;?>">
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
      ...
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        <td align="right" valign="middle" class="borderright borderbottom bggray">用户电话：</td>
        <td align="left" valign="middle" class="borderright borderbottom main-for">
	  ...
	  <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        ...
        <td align="left" valign="middle" class="borderright borderbottom main-for">
        <input type="text" name="academy" placeholder="<?php echo $row['academy'];?>"/>
        </td>
      </tr>
	  <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        <td align="right" valign="middle" class="borderright borderbottom bggray">学历：</td>
        <td align="left" valign="middle" class="borderright borderbottom main-for">
        <input type="text" name="education" placeholder="<?php echo $row['education'];?>"/>
        </td>
      </tr>
